...
def llvm_config_impl(rctx):
    ...
    print("{} known features: {}".format(rctx.attr.name, rctx.attr.extra_known_features))
    print("{} enabled features: {}".format(rctx.attr.name, rctx.attr.extra_enabled_features))
